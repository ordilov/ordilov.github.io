...
const home_page_url = 'https://ordilov.github.io/';
    ...
    return (
        <div>
            <Head>
                ...
                <meta name="author" content="ordilov"/>
                <meta name="keywords" content={'Blog'}/>

                <meta property="og:title" content={'Ordilov'} key="ogtitle"/>
                <meta property="og:description" content={description} key="ogdesc"/>
                <meta property="og:url" content={home_page_url} key="ogurl"/>
                <meta property="og:image" content={home_page_url + 'images/santha lakshmi narayana logo.png'}
                      key="ogimage"/>
                ...
                <link rel="canonical" href="https://ordilov.github.io/"/>
            ...
            <div>
                ...
                <div className='header-info'>
                    <div className='greetings'>
                        <p className='greetings-heading'>Ordinary</p>
                        <p className='greetings-statement'> </p>
                    </div>
                </div>
