			...
			{postsMetaData.map((metadata, index) => {
				...
				return (
					<div className = 'card-container' key = {metadata.metadata.title} >
			          ...
			          */}
                                {metadata.metadata.imgName &&  <img src={'/images/'+metadata.metadata.imgName} alt = {metadata.metadata.title} />}
							</div>

							<div className = 'info-container'>
				    		<div className = 'description-container'>
				    			<Link href={`/blog/${metadata.metadata.category}/${metadata.metadata.id}`} key = {metadata.metadata.title} >
